...
import {
    ...
    FaShareAlt, FaLink, FaInfoCircle,
    FaTrashRestore, FaTrash
} from 'react-icons/fa';
 ...
 * 
 * @param {Object} menuState - Trạng thái của menu { visible, x, y, file }
 * @param {Function} onClose - Callback khi đóng menu
 * @param {Function} onAction - Callback khi chọn action (action, file)
 */
